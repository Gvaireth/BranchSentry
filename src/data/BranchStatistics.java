...
public class BranchStatistics {
	...
	public int getTopCommentLength() {
		return topCommentLength;
	}

	public void setTopCommentLength(int topCommentLength) {
		this.topCommentLength = topCommentLength;
	}
}
